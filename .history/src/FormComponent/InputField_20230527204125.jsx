            ...
            <div className='container mb-5'>
                <form className='card'>
                    ...
                    <div className="card-footer">
                        <button type='submit' id='add' onClick={this.handleSubmit} className='btn btn-success' disabled={this.state.Disabled}>Thêm</button>
                        <button type='submit' id='update' className='btn btn-primary mx-2' disabled={this.state.Disabled} onClick={this.handleEdit} >Update</button>
                    </div>
                </form>
            </div>
        )
