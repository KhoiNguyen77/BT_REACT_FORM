...
export default class InputField extends PureComponent {
    ...
    handlleEdit = e => {
        const updateStudent = {...this.state.editStudent};
                        ...
                        <div className="row">
                            <div className="col-6">
                                ...
                                <input  type="number" onChange={()=>{
                                    this.handlleEdit()
                                }} id='key' uniqe="id" min-maxLength="[3,5]" data-type="number" className='form-control' onInput={this.handleInput} placeholder='Please enter your key' />
                            </div>
                            <div className="col-6">
