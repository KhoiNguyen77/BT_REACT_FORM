            ...
            <div className='container mb-5'>
                <form className='card'>
                    ...
                    <div className="card-footer">
                        <button type='submit' onClick={this.handleSubmit} className='btn btn-success' disabled={this.state.Disabled} style={{color} = "red"}>Thêm</button>
                        <button type='submit' className='btn btn-primary mx-2' disabled={this.state.disabledEdit} onClick={this.handleEdit} >Update</button>
                    </div>
                </form>
            </div>
        )
