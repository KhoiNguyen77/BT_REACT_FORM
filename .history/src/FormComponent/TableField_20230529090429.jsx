...
export default class TableField extends Component {
    handleSearch = () => {
        let keyword = document.querySelector("#btnSearch").value;
        let result = [];
        const { students } = this.props;
        let cloneStudents = [...students];
        cloneStudents.forEach(student => {
            if (student.key == keyword) {
                result.push(student)
            }
        })
        console.log(result);
                    ...
                    <div class="col">
                        <div>
                            ...
                            <div className="input-group">
                                <input type="text" className="form-control" placeholder="Nhập mã sinh viên" id="searchName" />
