...
export default class InputField extends PureComponent {
    ...
    //     if(nextProps.student !== prevState.editStudent){
    //         console.log("1");
    //     }
    // }
    handleInput = e => {
                    ...
                    <div className="card-body">
                        <div className="row">
                            <div className="col-6">
                                ...
                                <input value={this.state.editStudent.key} type="number" id='key' uniqe="id" min-maxLength="[3,5]" data-type="number" className='form-control' onInput={this.handleInput} placeholder='Please enter your key' />
                            </div>
                            <div className="col-6">
                                <p className='d-inline-block' >Name</p> <span className='text-danger'>{this.state.errors.name}</span>
                                <input value={this.state.editStudent.name} type="text" id='name' data-type="letter" className='form-control' onInput={this.handleInput} placeholder='Please enter your name' />
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-6">
                                <p className='d-inline-block'>Phone Number</p> <span className='text-danger'>{this.state.errors.phoneNumber}</span>
                                <input value={this.state.editStudent.phoneNumber} type="number" id='phoneNumber' className='form-control' min-maxLength="[8,10]" data-type="number" onInput={this.handleInput} placeholder='Please enter your phone number' />
                            </div>
                            <div className="col-6">
                                <p className='d-inline-block'>Email</p> <span className='text-danger'>{this.state.errors.email}</span>
                                <input value={this.state.editStudent.email} type="email" id='email' className='form-control' onInput={this.handleInput} data-type="email" placeholder='Please enter your email' />
                            </div>
                        </div>
                    </div>
