            ...
            <div className='container mb-5'>
                <form className='card'>
                    ...
                    <div className="card-footer">
                        ...
                        <button type='submit' className='btn btn-primary mx-2' disabled={this.state.disabledEdit} onClick={this.handleEdit} style={{ display: this.props.student ? 'block' : 'none' }} >Update</button>
                    </div>
                </form>
            </div>
        )
